...
uint8 icm20602_init (void)
{
    ...
    do
    {
        ...
        icm20602_write_register(ICM20602_CONFIG,         0x03);                 // 改为0x03，176HZ 1KHZ
        icm20602_write_register(ICM20602_SMPLRT_DIV,     0x04);                 // 改为0x04，采样速率 SAMPLE_RATE = INTERNAL_SAMPLE_RATE / (1 + SMPLRT_DIV)
        ...
        icm20602_write_register(ICM20602_ACCEL_CONFIG_2, 0x03);                 // 改为0x03,Average 4 samples   44.8HZ   //0x23 Average 16 samples
    }while(0);
    return return_state;
}
